...
function writeEncodedString(writer, value) {
  ...
  for (
    let i = 0, code = value.codePointAt(i++);
    code !== undefined;
    code = value.codePointAt(i++)
  ) {
...
MOCK_HANDLERS &&
  addHandler(
    // IPTC-NAA record
    1028,
    target => target._ir1028 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    // Print style
    1083,
    target => target._ir1083 !== undefined,
    (reader, target, left) => {
  ...
  (reader, target) => {
    ...
    target.resolutionInfo = {
      ...
      horizontalResolutionUnit:
        RESOLUTION_UNITS[horizontalResolutionUnit] || "PPI",
...
MOCK_HANDLERS &&
  addHandler(
    1077,
    target => target._ir1077 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    // Print flags
    10000,
    target => target._ir10000 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    // Color halftoning
    1013,
    target => target._ir1013 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    ...
    1016,
    target => target._ir1016 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    // ???
    1092,
    target => target._ir1092 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    // ICC Profile
    1039,
    target => target._ir1039 !== undefined,
    (reader, target, left) => {
...
addHandler(
  ...
  (writer, target) => {
    ...
    if (target.thumbnailRaw) {
      ...
      try {
        const dataUrl = target.thumbnail
...
MOCK_HANDLERS &&
  addHandler(
    // EXIF data 1.
    1058,
    target => target._ir1058 !== undefined,
    (reader, target, left) => {
...
MOCK_HANDLERS &&
  addHandler(
    1025,
    target => target._ir1025 !== undefined,
    (reader, target, left) => {
        ...
        while (left() > 0) {
          ...
          readSection(reader, 1, left => {
            if (key === "AnDs") {
              ...
              reader.logMissingFeatures &&
                reader.log("Unhandled subsection in #4000", key)
            }
          })
        }
      })
...
MOCK_HANDLERS &&
  addHandler(
    // Plug-In resource(s)
    4001,
    target => target._ir4001 !== undefined,
    (reader, target, left) => {
      if (MOCK_HANDLERS) {
...
MOCK_HANDLERS &&
  addHandler(
    // Plug-In resource(s)
    4002,
    target => target._ir4002 !== undefined,
    (reader, target, left) => {
